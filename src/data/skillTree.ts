...
export const TRACKS: Track[] = [
  {
    ...
    nodes: [
      ...
      { id: 'basics-n4', trackId: 'basics', title: 'Chain power', command: 'pipes', xp: 40, lessonIds: ['chaining.predict', 'chaining.predict2', 'basics.pipes', 'chaining.prove', 'chaining.capstone'], unlocks: ['basics-n5'] },
      { id: 'basics-n5', trackId: 'basics', title: 'Power user', command: 'chmod · > · man', xp: 40, lessonIds: ['permissions.predict', 'permissions.predict2', 'permissions.drill', 'permissions.prove', 'output.predict', 'output.predict2', 'output.drill', 'output.prove', 'manual.predict', 'manual.drill'], unlocks: ['sysadmin-n1'] },
    ],
  },
  {
    id: 'sysadmin',
